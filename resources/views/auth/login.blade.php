...
@section('content')
    <x-forms.auth-form method="post" title="Вход в аккаунт" action="{{ route('authenticate') }}">
        @csrf
        <x-forms.text-input
        ...
        <x-slot:buttons>
            <div class="space-y-3 mt-5 text-center">
                <div class="text-xxs md:text-xs">
                    <a href="{{ route('password.forgot') }}" class="text-white hover:text-white/70 font-bold">Забыли пароль?</a>
                </div>
                <div class="text-xxs md:text-xs">
